...
<nav class="ap-nav">
    ...
    <div class="ap-nav-links">
        <a href="/">Home</a>
        <a href="/Data_Explorer" class="active">D1 · Data Explorer</a>
        <a href="http://localhost:8502/">D2 · Forecast</a>
        <a href="http://localhost:8503/">D3 · Alerts</a>
        <a href="http://localhost:8502/">D4 · Admin</a>
    </div>
</nav>
